...
#define CFG_MAIN_FONT 7
#define CFG_POSBOX_BG_COLOR 8
#define CFG_POSBOX_BORDER_COLOR 9
#define CFG_POSBOX_FG_COLOR 10
#define CFG_POSBOX_FONT 11
#define CFG_WARP_MOUSE 12
