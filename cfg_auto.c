...
void config_init_auto_defaults(void) {
	...
	config_set(&global_config, CFG_MAIN_MONOSPACE_FONT, "Monospace-11");
	...
	config_set(&global_config, CFG_DEFAULT_AUTOINDENT, "1");
	config_set(&global_config, CFG_DEFAULT_SPACEMAN, "1");
